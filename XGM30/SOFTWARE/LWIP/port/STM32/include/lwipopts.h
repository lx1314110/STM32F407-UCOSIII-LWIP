...
#define MEMP_NUM_SYS_TIMEOUT    5 //30
#define MEMP_NUM_NETBUF         6 //10    	
#define MEMP_NUM_NETCONN        6 //6

/* ---------- Pbuf options ---------- */
/* PBUF_POOL_SIZE: the number of buffers in the pbuf pool. */
#undef  PBUF_POOL_SIZE
#define PBUF_POOL_SIZE          18//20

/* PBUF_POOL_BUFSIZE: the size of each pbuf in the pbuf pool. */
#undef  PBUF_POOL_BUFSIZE
#define PBUF_POOL_BUFSIZE       320 /* LWIP_MEM_ALIGN_SIZE(TCP_MSS+40+PBUF_LINK_HLEN) */
...
#define TCP_SND_QUEUELEN            (2 * TCP_SND_BUF)/TCP_MSS// (6 * TCP_SND_BUF)/TCP_MSS
