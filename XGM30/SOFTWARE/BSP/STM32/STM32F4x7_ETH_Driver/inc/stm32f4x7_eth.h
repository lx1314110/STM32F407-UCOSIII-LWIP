...
#define PHY_CONTRL2	                 0x1f

#define PHY_10M_HALF_DUPLEX_STATUS           ((uint16_t)(1<<2)) /* Value for KSZ8041PHY */
#define PHY_100M_HALF_DUPLEX_STATUS          ((uint16_t)(2<2)) /* Value for KSZ8041PHY */
#define PHY_10M_FULL_DUPLEX_STATUS           ((uint16_t)(5<<2)) /* Value for KSZ8041PHY */
#define PHY_100M_FULL_DUPLEX_STATUS          ((uint16_t)(6<<2)) /* Value for KSZ8041PHY */ 
