...
/* The KSZ8041 PHY: MII Interrupt Control Register  */
#define PHY_KSZ8041_MICR        ((uint16_t)0x1b)
#define PHY_KSZ8041_LINK_EN     ((uint16_t)0x0500) 
#define PHY_KSZ8041_LINK_STATUS ((uint16_t)0x0004) /* PHY link status interrupt mask */
#define PHY_LINK_INT_STATUS     ((uint16_t)0x0005) /* PHY link status interrupt mask */
